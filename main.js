document.getElementById("kadoIn").onclick = function() {if(fungsiAwal==0){audio.play();fungsiAwal=1;kadoIn.style="transition:all .8s ease;transform:scale(10);opacity:0";wallpaper.style="transform: scale(1.5);";ket.style="display:none";setTimeout(mulainama,700)}}
  ...
  afterComplete: function(){
    ...
    setTimeout(psmuncul,200);
  },}).go();
  }
  function kethalo2(){
  pshilang();fthilang();ftganti=1;setTimeout(ftmuncul,400);
  ...
  defpesanbawah = pesanbawah.innerHTML;
  function munculbwh(){pesanbawah.innerHTML=defpesanbawah;setTimeout(munculbwh2,2000);otomatis();}
  function munculbwh2(){pesanbawah.innerHTML=pesanbawah2.innerHTML;setTimeout(munculbwh3,2000);otomatis();}
  function munculbwh3(){pesanbawah.innerHTML=pesanbawah3.innerHTML;setTimeout(munculbwh,2000);otomatis();}
  function otomatis() {pesanbawah.style="position:relative;opacity:0;transform:scale(.3);";setTimeout(anim,300);} 
  function anim() {pesanbawah.style="position:relative;opacity:1;transform:scale(1);";}
  
  function psmuncul(){ps.style = "position:relative;opacity:1;visibility:visible;transform: scale(1);margin-top:0";mulaiketik1();fungsi=1;}
  function pshilang(){wallpaper.style="transform: scale(2);";bodyblur.style="opacity:.5";ps.style = "position:relative;transition:all .7s ease;";}
  ...
  async function menuju(){window.location = "https://wa.me/6285882499758?text=Hai,%20Putri%20Fauziah!%20Bolehkah%20Kita%20Berkenalan?";}
  ...
  vketik1=pesan.innerHTML;pesan.innerHTML = "";
  ...
  vketik2=pesanb.innerHTML;pesanb.innerHTML = "";
  function mulaiketik2(){
  pesan.innerHTML = "";pesan.style.display="none";
  ...
  vketik3=pesanc.innerHTML;pesanc.innerHTML = "";
  function mulaiketik3(){
  pesanb.innerHTML = "";pesanb.style.display="none";
  opsL.style.opacity="0";
  new TypeIt("#pesanc", {
  ...
  vketik4=pesand.innerHTML;pesand.innerHTML = "";
  vketik5=pesane.innerHTML;pesane.innerHTML = "";
  function mulaiketik4(){
  pesanc.innerHTML = "";pesanc.style.display="none";
  opsL.style.opacity="0";
  new TypeIt("#pesand", {
